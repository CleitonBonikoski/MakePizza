    ...
    public partial class MakeDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Ingrediente", t => t.ingredientePizza_IdIngrediente)
                .ForeignKey("dbo.Pizza", t => t.Pizza_IdPizza)
                .Index(t => t.ingredientePizza_IdIngrediente)
                .Index(t => t.Pizza_IdPizza);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Ingrediente_Pizza", "ingredientePizza_IdIngrediente", "dbo.Ingrediente");
            ...
            DropIndex("dbo.Ingrediente_Pizza", new[] { "ingredientePizza_IdIngrediente" });
